...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    \includegraphics[width=0.25\textwidth]{resources/LogoUCA.png}\\[1cm]
    {\Huge \bfseries Projet de Recherche Opérationnelle\\[0.5cm] \Large Flot maximum et flot maximum de coût minimum}\\[2cm]
...
Les arcs en rouge représentent la coupe minimale trouvée après le calcul. Ici,
...
\begin{figure}[H]
    ...
    \caption{Graphe obtenu après le calcul du flot max sur l'exemple fourni.}
\end{figure}

On obtient un flot de 15 avec la coupe minimal qui contient les arcs saturés (0->2, 1->3)

\subsubsection{Flot max min cost}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{resources/results/exemple_with_cost.pdf}
    \caption{Graphe obtenu après le calcul du min cost flot max sur l'exemple fourni.}
\end{figure}
...
\subsubsection{Flot max min cost dans (t,s)}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{resources/results/exo3_min_cost1.pdf}
    \caption{Graphe obtenu après le calcul du flot max min cost de (t,s) sur l'exemple fourni.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Graphe obtenu après le calcul du flot max min cost de (0,4) sur l'exemple fourni.}
\end{figure}
